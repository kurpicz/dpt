...
#pragma once
#ifndef DPT_UTIL_UINT_TYPES_HEADER
#define DPT_UTIL_UINT_TYPES_HEADER

#if defined(__GNUC__) || defined(__clang__)
#define DPT_LIKELY(c)   __builtin_expect((c), 1)
#define DPT_UNLIKELY(c) __builtin_expect((c), 0)
#else
#define DPT_LIKELY(c)   c
#define DPT_UNLIKELY(c) c
#endif

#if defined(__GNUC__) || defined(__clang__)
#define DPT_ATTRIBUTE_PACKED __attribute__ ((packed))
#else
#define DPT_ATTRIBUTE_PACKED
#endif
...
class numeric_limits<dpt::UIntPair<HighType> >
{
public:
    using UIntPair = dpt::UIntPair<HighType>;
...
#endif // DPT_UTIL_UINT_TYPES_HEADER
